                ...
                <div class="profile-body">
                    ...
                    <div class="profile-section">
                        ...
                        <div class="info-item" style="grid-column: span 2;">
                            ...
                            <div class="info-value"><?php echo htmlspecialchars($_SESSION['description'] ?? 'Không có thông tin mô tả.'); ?></div>
                        </div>
                        
                        <div class="info-item">
                            <span class="info-label">Ngày tham gia</span>
                            <div class="info-value"><?php echo htmlspecialchars($_SESSION['join_date'] ?? date('d/m/Y')); ?></div>
                        </div>
                    ...
                    <div class="profile-actions">
                        <a href="edit_admin.php?id=<?php echo htmlspecialchars($_SESSION['user_id']); ?>" class="btn btn-primary">Chỉnh sửa thông tin</a>
                    </div>
                </div>
            </div>
        </div>
